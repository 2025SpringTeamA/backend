...
from app.schemas.admin import AdminBase, AdminLogin, AdminResponse
from app.models import Admin, User, Session as ChatSession, Message
from app.core.database import get_db
from app.utils.auth import hash_password, verify_password, create_access_token

@router.post("/admin/register/")
async def register_admin(admin_data: AdminBase, db: Session = Depends(get_db)):
    if db.query(Admin).filter_by(email=admin_data.email).first():
